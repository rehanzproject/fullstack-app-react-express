...
const navigation = [
  ...
  { name: "Most Sales", href: "#mostSales" },
  { name: "Menu", href: "#menu" },
...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="bg-black/50 fixed top-0 inset-x-0">
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          "text-white hover:text-success-10 rounded-md px-3 py-2 text-sm font-medium"
                        )}
